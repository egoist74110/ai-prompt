...
- **实现方**：当前请求要你写/改代码或配置并交付。→ 下面的 Cross-Review Gate 和 Regression / Cleanup Gate 适用。
...
在实现、自检、必要的交叉审查、补修和复验都结束后，**最终回复前读取并执行 `capabilities/cleanup.md`**。
